    ...
    <div className="bg-[#F4F4F4]">
      <div className="text-center lg:flex md:flex flex-row justify-center items-center gap-6 w-fit container mx-auto  h-full min-h-screen  ">
        <div className=" h-full w-full relative">
          ...
          <h1 className="lg:text-4xl text-2xl font-bold"> "Listening to your customers is the first step toward innovation" </h1>
          </div>
        </div>
          ...
          <div className="flex justify-center items-center ">
            ...
            >
              ...
              <div className="lg:flex md:flex flex-row justify-between items-center">
                <p className="text-[14px] text-[#195671] font-semibold hover:bg-[#E9EBF0]underline pb-4">
                  {" "}
                ...
                <Link
                  ...
                  className="text-[14px] text-[#195671] font-semibold hover:bg-[#E9EBF0]underline pb-4"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="py-2">
                <p className="text-[16px] text-[#424242] font-medium ">or</p>
              </div>
