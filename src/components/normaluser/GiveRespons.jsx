      ...
      <div className="bg-[#F4F4F4] min-h-screen py-8">
        <div className="container mx-auto">
            <div className="flex items-center justify-between py-4">
                <h3 onClick={() => window.history.back()} className="text-2xl font-bold text-[#424242] cursor-pointer"> <LeftOutlined className="text-xl"/> Bata</h3>
