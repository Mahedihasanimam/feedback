  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
        ...
        Untitled form 
           ...
           <p className="text-[16px] text-[#424242] font-medium border-b pb-2   ">Form description</p>
      ...
      {sections.map((section) => (
        ...
        >
          ...
          {section.type === "Short answer" && (
              ...
              <p className="text-[16px] text-[#424242] font-normal border-b pb-2 mt-4   ">What is the capital city of Bangladesh?</p>
              <Input value={"Dhaka"}  prefix={
               <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M1 1H15M1 5H15M1 9H7" stroke="#424242" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
               </svg>
