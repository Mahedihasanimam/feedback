...
const DownLoadQrcode = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = qrimage; // Set the href to the image source
    link.download = "qr-code.png"; // Set the download attribute with a filename
        ...
        <div className="w-full">
          <div className="bg-[#FFFFFF] p-4 rounded-lg">
            <div className="h-full w-fit mx-auto relative">
              <img
                className="w-[140px] h-[140px] block mx-auto"
                src={profile}
                alt="sideimage"
              />
            ...
            <div className="flex items-center space-x-4 w-fit mx-auto py-6">
              <strong className="text-[16px] font-bold">Edit Profile</strong>
            ...
            <div className="w-full">
              <Image className="mb-6" src={qrimage} alt="qr-code" preview={false} />
              <Form
                name="profile"
                layout="vertical"
                onFinish={onFinish}
